...
独立的项目设计文档，适用对象： **Football Manager 26**。
...
- **战术比较表** (Tactic comparison sheets) — 规划模块，尚未实现。
- **训练负荷场景** (Training load scenarios) — 规划模块，尚未实现。
- **生涯快照索引** (Career snapshot index) — 规划模块，尚未实现。
