...
<div align="center">
  <img src="./public/logo.svg" alt="TouchlineTrials — Football Manager 26 — Formation" width="64" height="64">
  <h1>TouchlineTrials — Football Manager 26 — Formation</h1>
</div>

An independent project specification for Football Manager 26, covering tactic comparison sheets, training load scenarios, career snapshot index.
...
<img src="./public/screenshots/desktop-main.svg" alt="Football Manager 26 — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Football Manager 26 — compact concept, not a screenshot" width="250">
<br>
...
- **Tactic comparison sheets** — planned module; not implemented.
- **Training load scenarios** — planned module; not implemented.
- **Career snapshot index** — planned module; not implemented.

The proposed workflow separates tactic comparison sheets from training load scenarios, with career snapshot index retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Tactic comparison sheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TouchlineTrials — Football Manager 26 — Formation — specification review workflow">
<br>
...
### Tactic comparison sheets

Define the input and expected outcome for module 1. Record the Football Manager 26 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Training load scenarios

Define the input and expected outcome for module 2. Record the Football Manager 26 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Career snapshot index

Define the input and expected outcome for module 3. Record the Football Manager 26 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Football Manager 26 |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Tactic comparison sheets |
